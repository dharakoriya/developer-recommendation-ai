# DevAlign AI Main Application Entrypoint (v2.0)
...
app.include_router(analytics_router, prefix=f"{settings.API_PREFIX}/analytics", tags=["Analytics & Project Intelligence"])
...
app.include_router(risk_router, prefix=f"{settings.API_PREFIX}/risk", tags=["Risk Assessment Engine"])
