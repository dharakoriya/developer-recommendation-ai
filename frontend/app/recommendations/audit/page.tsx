      ...
      <div className="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        {loading ? (
          ...
          <div className="p-12 text-center bg-slate-900/60 border border-slate-800 rounded-2xl space-y-3">
            <div className="inline-flex p-3 rounded-full bg-slate-800/80 text-purple-400">
              <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 className="text-base font-bold text-slate-200">No recommendation audit records yet</h3>
                  ...
                  {audits.map((a) => {
                    ...
                    return (
                      <tr key={a.id} className="hover:bg-slate-800/40 transition">
                        <td className="p-3.5 font-mono text-slate-400">{dateStr}</td>
                        ...
                        <td className="p-3.5 font-mono font-bold text-indigo-400">{Math.round(scoreVal)} / 100</td>
                        <td className="p-3.5 font-mono text-slate-300">{a.model_version || 'baseline-v1.1'}</td>
