    ...
    <AppShell>
      <div className="max-w-5xl mx-auto space-y-8 py-4">
        ...
        <div className="flex items-center justify-between border-b border-gray-800 pb-5">
          ...
          <Link
            href="/projects"
            className="px-3.5 py-1.5 text-xs font-medium text-gray-300 bg-gray-900 border border-gray-700 hover:border-gray-600 rounded-lg transition-colors"
          >
            ← Back to Projects
          </Link>
        </div>
        ...
        {mode === 'CHOICE' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
              ...
              className="group cursor-pointer p-6 bg-gray-900/60 border border-gray-800 hover:border-blue-500/50 rounded-xl transition-all hover:shadow-lg hover:shadow-blue-500/5 space-y-4 flex flex-col justify-between"
            >
              <div>
                <div className="w-12 h-12 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 text-xl font-semibold mb-4 group-hover:scale-105 transition-transform">
                  📁
                </div>
              ...
              <div className="pt-4 border-t border-gray-800/80 flex items-center justify-between">
                <span className="text-xs font-medium text-gray-400">Traditional workflow</span>
            ...
            <div
              ...
              className="group cursor-pointer p-6 bg-gradient-to-br from-indigo-950/40 via-purple-950/20 to-gray-900/60 border border-purple-500/30 hover:border-purple-400/60 rounded-xl transition-all hover:shadow-xl hover:shadow-purple-500/10 space-y-4 flex flex-col justify-between relative overflow-hidden"
            >
              ...
              <div>
                <div className="w-12 h-12 rounded-lg bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-300 text-xl font-semibold mb-4 group-hover:scale-105 transition-transform">
                  ✨
                </div>
              ...
              <div className="pt-4 border-t border-gray-800/80 flex items-center justify-between">
                <span className="text-xs font-medium text-purple-300/80">Intelligent breakdown</span>
                <span className="text-xs font-semibold text-purple-300 group-hover:translate-x-1 transition-transform">
          ...
          <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-6 max-w-2xl mx-auto space-y-6">
            <div className="flex items-center justify-between border-b border-gray-800 pb-4">
              <h2 className="text-lg font-semibold text-white">Manual Project Details</h2>
              <button
                type="button"
            ...
            <form onSubmit={handleCreateManual} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-950 border border-gray-800 rounded-lg px-3.5 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
                />
              </div>
