    ...
    <AppShell>
      <div className="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {data && (
            <span className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 font-mono">
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-4">
                <h3 className="text-lg font-bold text-slate-100">Task Difficulty Distribution</h3>
                <p className="text-xs text-slate-400">Breakdown of system tasks by complexity tier</p>
                    ...
                    return (
                      <div key={tier} className="space-y-1">
                        <div className="flex justify-between text-xs font-semibold">
                          <span className="text-slate-300 uppercase tracking-wider">{tier}</span>
                          <span className="text-slate-400 font-mono">{count} tasks ({pct.toFixed(0)}%)</span>
                        </div>
              ...
              <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-4">
                <h3 className="text-lg font-bold text-slate-100">Top Productivity Leaders</h3>
                <p className="text-xs text-slate-400">Ranked by weighted task difficulty completed</p>

                <div className="space-y-3 pt-2">
                  {data.highest_productivity.map((dev, idx) => (
                    <div key={dev.developer_id} className="flex items-center justify-between p-3 rounded-xl bg-slate-800/40 border border-slate-700/50">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 font-mono">{dev.completed_tasks} completed tasks</p>
                        </div>
                      </div>
              ...
              {/* Best Streaks */}
              <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-4">
                <h3 className="text-lg font-bold text-slate-100">Streak Champions</h3>
                <p className="text-xs text-slate-400">Active consecutive day delivery streaks</p>
