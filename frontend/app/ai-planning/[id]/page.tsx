        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-gray-800 pb-5">
          <div className="space-y-1">
            ...
            {plan.ai_provider && (
              <div className="flex flex-wrap items-center gap-2 mt-2 pt-2">
                <span className="text-xs text-slate-500 dark:text-slate-400">Planned by:</span>
                <span className={`px-2 py-0.5 text-[10px] font-semibold rounded-full border ${plan.ai_provider?.includes('heuristic') ? 'bg-indigo-50 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-700/50' : 'bg-fuchsia-50 dark:bg-fuchsia-900/40 text-fuchsia-700 dark:text-fuchsia-300 border-fuchsia-200 dark:border-fuchsia-700/50'}`}>
                ...
                <span className="text-[10px] text-slate-600 dark:text-slate-400 font-mono bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-1.5 py-0.5 rounded">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-3.5 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors flex items-center gap-1.5 shadow-sm"
            >
              🔄 Regenerate Plan
            </button>
            <button
              onClick={() => setShowAddModal(true)}
              className="px-3.5 py-2 text-xs font-semibold text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-500/20 border border-purple-200 dark:border-purple-500/30 hover:bg-purple-100 dark:hover:bg-purple-500/30 rounded-lg transition-colors flex items-center gap-1.5"
            >
              ➕ Add Task
            </button>
          </div>
